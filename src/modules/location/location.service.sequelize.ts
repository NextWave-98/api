...
//     if (!locationCode) {
//       locationCode = await this.generateLocationCode(data.locationType || 'BRANCH');
//     } else {
...
//     return this.getLocationsByType('WAREHOUSE', page, limit, isActive);
//   }

//   async getBranches(page = 1, limit = 10, isActive?: boolean) {
//     return this.getLocationsByType('BRANCH', page, limit, isActive);
//   }
